    ...
    return (
        ...
        >
            ...
            <div className="container relative z-10 px-6 mx-auto text-center max-w-5xl">
                ...
                <div
                    ref={bookRef}
                    className="relative w-full max-w-5xl mx-auto mt-20 aspect-video bg-white rounded-2xl shadow-[0_32px_72px_-16px_rgba(0,0,0,0.25)] border border-ledger-border perspective-2000 overflow-hidden"
